              ...
              {/* Header Profile Section - Native Mobile Style */}
                <section className="flex flex-col items-center text-center">
                  <div className="relative mb-8">
                    <motion.div 
                      whileTap={{ scale: 0.95 }}
                      className="w-36 h-36 rounded-[48px] p-1.5 bg-gradient-to-tr from-malachite-400 to-sea-green-500 shadow-xl shadow-primary/10"
                    >
                      <div className="w-full h-full rounded-[44px] bg-background p-1">
                        <Avatar className="w-full h-full rounded-[40px] border-none shadow-inner bg-muted">
                          <AvatarImage src={profile?.avatar_url} className="object-cover" />
                          <AvatarFallback className="bg-muted text-muted-foreground text-4xl font-heading">
