    ...
    <main className="min-h-screen pb-32 bg-evergreen-950 bg-[radial-gradient(circle_at_50%_0%,_#0D2818_0%,_#0a2013_100%)]">
      ...
      <div className="px-6 pt-24 relative z-10 space-y-10 max-w-6xl mx-auto">
        ...
        <div className="space-y-1">
          <h4 className="text-[10px] font-bold text-malachite-500 uppercase tracking-[0.4em]">Ranking Protocols</h4>
        ...
        {topPlayer && (
          <motion.div 
            ...
            className="bg-malachite-500/20 backdrop-blur-xl border border-malachite-500/30 p-10 rounded-[3rem] shadow-2xl relative overflow-hidden group"
          >
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
              <div className="relative">
                <div className="absolute -inset-4 bg-malachite-500/20 rounded-full blur-2xl animate-pulse" />
                <Avatar className="w-40 h-40 border-8 border-white/10 shadow-2xl relative z-10">
                  <AvatarImage src={topPlayer.avatar_url} />
                  <AvatarFallback className="bg-evergreen-950 text-white text-4xl font-heading">
                    {topPlayer.name.substring(0, 2).toUpperCase()}
                  </AvatarFallback>
                </Avatar>
                <div className="absolute -bottom-2 -right-2 bg-malachite-500 text-white p-3 rounded-2xl shadow-xl z-20 border-4 border-evergreen-950">
              ...
              <div className="flex-1 text-center md:text-left space-y-4">
                <div className="flex items-center justify-center md:justify-start gap-3">
                  <Badge className="bg-malachite-500 text-white border-none rounded-full px-4 py-1.5 text-[9px] font-bold uppercase tracking-widest shadow-lg shadow-malachite-500/20">
                    ARENA CHAMPION
                  </Badge>
                  <span className="text-white/40 text-[10px] font-bold uppercase tracking-widest flex items-center gap-2">
                    <Star size={12} className="text-malachite-500" /> RANK #1
                  </span>
                </div>
                <h2 className="text-5xl font-heading tracking-tight leading-none text-white">{topPlayer.name}</h2>
                <p className="text-white/40 font-bold text-xs uppercase tracking-[0.2em]">Affiliation: <span className="text-malachite-500">{topPlayer.team}</span></p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 w-full md:w-auto">
                {[
                  ...
                  <div key={i} className="bg-white/5 backdrop-blur-md p-6 rounded-[2rem] border border-white/10 text-center min-w-[140px] group-hover:border-malachite-500/30 transition-all">
                    <stat.icon size={20} className="mx-auto mb-2 text-malachite-500 opacity-60" />
            ...
            <div className="absolute top-[-20%] right-[-10%] w-64 h-64 bg-malachite-500/20 rounded-full blur-[100px]" />
          </motion.div>
        )}
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-[2.5rem] border border-white/10 p-6 shadow-2xl flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input 
              className="bg-white/5 border-none pl-14 rounded-2xl h-14 text-xs font-bold tracking-wide focus-visible:ring-malachite-500 placeholder:text-white/20 text-white" 
          ...
          <div className="flex gap-2">
            <Select value={selectedTournament} onValueChange={setSelectedTournament}>
              ...
              <SelectContent className="rounded-2xl border-white/10 bg-evergreen-800 text-white">
            ...
            <Button className="h-14 w-14 rounded-2xl bg-white/5 text-white hover:bg-malachite-500 transition-all p-0 border border-white/10">
              <Download size={20} />
            </Button>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-end justify-between px-2">
            ...
            <div className="flex items-center gap-2 bg-malachite-500/10 px-4 py-2 rounded-full border border-malachite-500/20">
              <div className="w-1.5 h-1.5 rounded-full bg-malachite-500 animate-pulse" />
              <p className="text-[8px] font-bold text-malachite-500 uppercase tracking-widest">Live Sync: Active</p>
            </div>
          </div>
            ...
            <Table>
              <TableHeader className="bg-white/[0.02]">
                <TableRow className="border-white/5 hover:bg-transparent h-20">
                  ...
                  <TableHead className="font-bold text-white/20 uppercase text-[9px] tracking-[0.3em] text-center cursor-pointer hover:text-malachite-500 transition-colors" onClick={() => handleSort("points")}>
                  ...
                  <TableRow key={player.id} className="border-white/5 hover:bg-white/[0.02] transition-colors h-24 group">
                    <TableCell className="pl-10">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-heading text-lg transition-all duration-500 ${
                        index === 0 ? "bg-malachite-500 text-white shadow-lg shadow-malachite-500/20 scale-110" :
                    ...
                    <TableCell>
                      <div className="flex items-center gap-5">
                        ...
                        <div className="space-y-0.5">
                          <p className="font-heading text-white group-hover:text-malachite-500 transition-colors">{player.name}</p>
                          <p className="text-[9px] text-white/30 font-bold uppercase tracking-widest">@{player.username}</p>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <Badge variant="outline" className="rounded-full border-white/5 text-white/40 font-bold text-[9px] tracking-widest px-3 py-0.5 group-hover:border-malachite-500/20 group-hover:text-malachite-500 transition-all">
                        {player.team}
                      </Badge>
                    </TableCell>
