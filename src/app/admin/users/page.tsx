          ...
          {[
            ...
            >
              <div className="flex justify-between items-start relative z-10">
                ...
                <div className="p-4 rounded-2xl bg-white/10 text-malachite-500 group-hover:scale-110 transition-transform duration-500">
                  <stat.icon size={24} />
                </div>
              </div>
                ...
                {filteredUsers.length > 0 ? (
                  filteredUsers.map((user, idx) => (
                    <motion.div 
                      ...
                      layout
                      className="bg-white/5 backdrop-blur-xl rounded-[2.5rem] p-6 flex items-center justify-between border border-white/10 hover:border-malachite-500/30 hover:bg-white/[0.08] transition-all duration-500 group cursor-pointer"
                      onClick={() => {
                    ...
                    >
                      <div className="flex items-center gap-6">
                        <Avatar className="w-16 h-16 border-2 border-white/10 shadow-xl transition-transform duration-500 group-hover:scale-110">
                          ...
                          <AvatarFallback className="bg-malachite-500 text-white font-heading text-lg">
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="rounded-[1.5rem] border-white/10 w-52 p-2 bg-evergreen-800 text-white shadow-2xl">
                ...
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={i} className="bg-white/5 p-6 rounded-[2rem] border border-white/10 flex flex-col gap-3">
                      <div className="w-12 h-12 rounded-2xl bg-white/5 text-malachite-500 flex items-center justify-center">
                        <stat.icon size={24} />
                      </div>
              ...
              <div className="p-10 bg-evergreen-800 border-t border-white/10 shadow-2xl">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-64 rounded-[2rem] p-3 border-white/10 shadow-2xl bg-evergreen-800 text-white">
