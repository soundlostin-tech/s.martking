      ...
      {/* Brand Header */}
        <div className="p-8">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-pastel-lavender rounded-2xl flex items-center justify-center text-onyx shadow-lg shadow-pastel-lavender/20">
              ...
              >
                ...
                >
                  <div className={`p-2 rounded-xl transition-colors ${
                    isActive ? "bg-white/10 text-pastel-lavender" : "bg-black/[0.03] group-hover:bg-black/[0.05]"
                  }`}>
                  ...
                  {isActive && (
                    <motion.div 
                      ...
                      className="ml-auto w-1.5 h-1.5 rounded-full bg-pastel-lavender shadow-[0_0_8px_rgba(212,181,255,0.8)]"
                    />
                  )}
                </motion.div>
              </Link>
