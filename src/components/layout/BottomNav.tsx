...
export function BottomNav() {
  const pathname = usePathname();
    ...
    return (
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-t border-border pb-safe shadow-[0_-5px_20px_-10px_rgba(0,0,0,0.1)]">
